...
<head>
    ...
    <title>Admin Panel - Tiện nghi</title>
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4">Tiện nghi và Tính năng</h3>
            ...
            <form id ="feature_s_form">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Thêm tínhh năng</h5>
                    </div>
                    ...
                    <div class="modal-footer">
                       ...
                       <button type="submit" class="btn custom-bg text-white shadow-none">Accept</button>
                    </div>
                </div>
            </form>
        </div>
